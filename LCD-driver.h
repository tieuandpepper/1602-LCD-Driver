...
void LCD_Print_Str(char* str, unsigned char cursor_position);   // Write string to screen
void LCD_Overflow(void);                                        // shift display if characters overflow LCD "need improvement"
